...
Namespace DynamicComponents
    Public Class DynamicReport
        ...
        Public Sub generateReport(ByVal ReportName As String, ByVal ReportPath As String)
            ...
            _CompanyId = "EgyFirst Software LLC."
            _ProductId = "DynamicReport"
            _ProductVersion = "V. 4.0"

            _CompanyInfo = "Dynamic Report V. 4.0" + vbCrLf
            _CompanyInfo += "Powered by EgyFirst Software, LLC." + vbCrLf
            _CompanyInfo += "Free 30 Days Trial Version"

            _buynow_URL = "https://secure.avangate.com/order/checkout.php?PRODS=4692446&QTY=1&CART=1&CARD=1&ORDERSTYLE=nLWonZXfrnY="
            ...
            If FieldsCount > 0 Then
                ...
                Using writer As XmlWriter = XmlWriter.Create((ReportPath + ReportName + ".xml"), settings)
                    ...
                    If limit < ds.Tables(0).Rows.Count Then
                        MsgBox("This is a limited version of DC Dynamic Report" + vbCrLf + "Maximum number of rows is 100" + vbCrLf + "Buy full version from http://egy1st.com/dynamic-report/")
                        Exit Sub
                    End If
